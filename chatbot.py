...
class SmartMirror(QMainWindow):
    def __init__(self):
        ...
        self.mirror_response_label.setStyleSheet("color: white; font-size: 14px; background-color: transparent;")
        self.mirror_response_label.setAlignment(Qt.AlignLeft)
        self.mirror_response_label.setWordWrap(True)
        self.mirror_response_label.setGeometry(20, 180, 300, 60)  # Positioned below weather info
        ...
        # Fetch city by IP
        self.city = "New York"  # Default city
    ...
    def start_chatbot(self):
        print("Smart Mirror AI is ready!\n")
        while True:
    ...
    def display_typing_effect(self, text):
        ...
        self.typing_effect_thread = TypingEffectThread(text)
        self.typing_effect_thread.update_text.connect(self.mirror_response_label.setText)
